      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-5xl lg:max-w-6xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-6">
              <div className="rounded-lg border border-amber-300 bg-amber-100 p-4 dark:bg-amber-900/50 dark:border-amber-700">
                <h4 className="text-sm font-bold text-amber-900 dark:text-amber-100 mb-1.5">Informasi Otomatisasi Jurnal</h4>
                <p className="text-sm leading-relaxed font-medium text-amber-900 dark:text-amber-50">
                  Sistem akan otomatis mencatat sisi <strong className="font-extrabold text-amber-950 dark:text-white">Debit</strong> ke Akun Penerima yang Anda pilih di atas sebesar total nominal di bawah ini. Anda hanya perlu memasukkan rincian asal dana pada tabel Kredit (contoh: Piutang, Pendapatan Bunga).
                </p>
              </div>
