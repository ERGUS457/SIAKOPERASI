      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-5xl lg:max-w-6xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-6">
              <div className="rounded-lg border border-amber-200 bg-amber-50/80 p-4 dark:bg-amber-950/40 dark:border-amber-800">
                <h4 className="text-sm font-semibold text-amber-700 dark:text-amber-200 mb-1.5">Informasi Otomatisasi Jurnal</h4>
                <p className="text-[13px] leading-relaxed text-amber-700 dark:text-amber-100/90">
                  Sistem akan otomatis mencatat sisi <strong className="font-bold text-amber-800 dark:text-amber-100">Debit</strong> ke Akun Penerima yang Anda pilih di atas sebesar total nominal di bawah ini. Anda hanya perlu memasukkan rincian asal dana pada tabel Kredit (contoh: Piutang, Pendapatan Bunga).
                </p>
              </div>
